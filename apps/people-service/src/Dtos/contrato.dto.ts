...
export class CreateContratoDto {
  ...
  @ApiProperty({
    description: 'Salario establecido en el contrato',
    example: '1500.00',
  })
  @IsNumberString()
  salario: string;
  ...
  @ApiPropertyOptional({
    ...
    example: 'Responsable del mantenimiento general del edificio',
  })
  @IsOptional()
  @IsString()
  ...
  @ApiPropertyOptional({
    ...
    default: ESTADO_CONTRATO.ESTADO_VIGENTE,
  })
  @IsOptional()
...
export class ContratoResponseDto {
  ...
  @ApiPropertyOptional({
    description: 'Número de cambios en el historial',
    example: 2,
  })
